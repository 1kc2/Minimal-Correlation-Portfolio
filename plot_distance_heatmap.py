...
import timeseries_network as tsx
...
def distance_heatmap():
    ...
    H = tsx.timeseries_correlation_network(data=df, corr_param='dcor', prune=0.35)
    #H = bnx.build_network()
    ...
    # creates a new column in the distance dataframe for each stock ticker and preprocessesses it for heatmap plotting
